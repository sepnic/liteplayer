...
#ifndef _HELIX_AAC_ASSEMBLY_H_
#define _HELIX_AAC_ASSEMBLY_H_
...
{
    __asm__ ("rev16 %0, %1" : "=r" (value) : "r" (value) );
    return(value);
}
 ...
 * target architecture: x86
 */
#elif defined(USE_DEFAULT_STDLIB) || defined(__GNUC__) && (defined(__i386__) || defined(__amd64__)) || (defined (_SOLARIS) && !defined (__GNUC__) && defined(_SOLARISX86))
