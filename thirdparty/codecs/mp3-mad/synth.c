...
/* LITEPLAYER_CONFIG_MAD_FPM_DEFAULT without OPT_SSO will actually lose accuracy and performance */

# if defined(LITEPLAYER_CONFIG_MAD_FPM_DEFAULT) && !defined(OPT_SSO)
#  define OPT_SSO
# endif
