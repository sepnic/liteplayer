                           ...
                           real_t ***ppp_t1)
{
    ...
    *ppp_q0 = (real_t **) faad_calloc(mm, sizeof(real_t *));
    for (n = 0; n < mm; ++n)
    {
        (*ppp_q0)[n] = (real_t *) faad_calloc(mm, sizeof(real_t));
    }
    for (n = 0; n < mm/2; ++n)
    {
        for (i = 0; i < mm; ++i)
    ...
    *ppp_t0 = (real_t **) faad_calloc(mm, sizeof(real_t *));
    *ppp_t1 = (real_t **) faad_calloc(mm, sizeof(real_t *));
    for (n = 0; n < mm; ++n)
    {
        (*ppp_t0)[n] = (real_t *) faad_calloc(kk, sizeof(real_t));
        (*ppp_t1)[n] = (real_t *) faad_calloc(kk, sizeof(real_t));
    }
    for (n = 0; n < mm; ++n)
    {
        for (k = 0; k < kk; ++k)
