...
#define DEFAULT_SOURCE_TASK_STACKSIZE        ( 1024*4 )              // NOTUSED
#define DEFAULT_SOURCE_HTTP_RINGBUF_SIZE     ( 1024*128 )
#define DEFAULT_SOURCE_FILE_RINGBUF_SIZE     ( 1024*32 )
#define DEFAULT_SOURCE_STREAM_RINGBUF_SIZE   ( 1024*32 )
...
#define DEFAULT_SINK_RINGBUF_SIZE            ( 1024*8 )              // NOTUSED
